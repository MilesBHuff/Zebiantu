...
cat >> "$TARGET$ENV_SETUP_ENVFILE" <<EOF
## Added during installation
DISTRO='$DISTRO'
ENV_FILESYSTEM_ENVFILE='$ENV_FILESYSTEM_ENVFILE'
ENV_SETUP_ENVFILE='$ENV_SETUP_ENVFILE'
ENV_TUNE_IO_SCRIPT='$ENV_TUNE_IO_SCRIPT'
ENV_TUNE_ZFS_SCRIPT='$ENV_TUNE_ZFS_SCRIPT'
TARGET='$TARGET'
EOF
