...
case $DISTRO in
    ...
    2) apt install -y linux-image-generic linux-headers-generic dkms ;;
esac

## Install firmware and drivers
echo ':: Installing firmware...'
case $DISTRO in
    1) apt install -y -t "$DEBIAN_VERSION-backports" firmware-linux-free firmware-linux-nonfree firmware-misc-nonfree ;;
    2) apt apt install -y linux-firmware ubuntu-drivers-common ; ubuntu-drivers autoinstall ;;
esac

## Install init
echo ':: Installing initramfs...'
apt install -y initramfs-tools
#TODO: Switch to dracut
