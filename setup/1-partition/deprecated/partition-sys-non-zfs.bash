#!/usr/bin/env bash
function helptext {
    echo 'Usage: partition-sys-non-zfs.bash device0 [device1 ...]'
    echo
    ...
    echo 'There will be an ESP and an OSP.'
    echo
...
for DEVICE in "$@"; do
    ...
    ## Create OSP
    sgdisk --set-alignment=$ALIGNMENT --new=2:0:0 --typecode=2:8300 --change-name=2:"${ENV_NAME_OSP^^}" "$DEVICE"
done
exit $EXIT_CODE
